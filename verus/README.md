...
| `neon/model.rs`                         | Per-instruction spec of the NEON surface (PMULL, EOR, AND, TBL, TRN/UZP, shifts, moves, the LE transmute view), definitions only, each citing DDI 0487.                                        |
